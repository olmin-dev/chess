...
Description: Simulationde jeu d'echec en C à paritr du terminal de commandes

Compilation: make \\ compile le projet global
	     make exe \\ compile et execute le projet global
